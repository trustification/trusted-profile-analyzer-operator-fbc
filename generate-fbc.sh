...
FROM registry.redhat.io/openshift4/ose-operator-registry-rhel9:$1
...
{
if [[ "$2" == "brew" ]]; then
    sed -i 's|image: registry.redhat.io/rhtpa/rhtpa-rhel9-operator|image: brew.registry.redhat.io/rhtpa/rhtpa-rhel9-operator|g' "${frag}"/graph.yaml
fi
}
