...
{
if [[ "$2" == "brew" ]]; then
    sed -i 's|image: registry.redhat.ioregistry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|image: brew.registry.redhat.ioregistry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|g' "${frag}"/graph.yaml
fi
}
...
{
if [[ "$2" == "brew" ]]; then
    sed -i 's|image: brew.registry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|image: registry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|g' "${frag}"/graph.yaml
    sed -i 's|brew.registry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|registry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator|g' "${frag}"/catalog/rhtpa-operator/catalog.json
fi
}
...
case $cmd in
  ...
  "--comment-graph")
    ...
    grep -E "^image: [brew\.]*registry.redhat.io/rhtpa-tech-preview/rhtpa-rhel9-operator[-rhel9]*@sha256" "$frag"/graph.yaml | while read -r line ; do
      image=${line/image: /}
